                                ...
                                if ((long) documentSnapshot.get("view_type") == 0) {
                                    ...
                                    for (long x = 1; x <= no_of_products; ++x) {
                                        horizontalProductScrollModelList.add(
                                                new HorizontalProductScrollModel(documentSnapshot
                                                        .get("product_ID_" + x).toString()
                                    ...
                                    lists.get(index).add(new HomePageModel(2, documentSnapshot
                                            .get("layout_title").toString(),
                                    ...
                                    List<HorizontalProductScrollModel> gridLayoutModelList =
                                            new ArrayList<>();
                                    ...
                                    lists.get(index).add(new HomePageModel(3, documentSnapshot
                                            .get("layout_title").toString(),
                                            documentSnapshot.get("layout_background").toString(),
                                            gridLayoutModelList));
