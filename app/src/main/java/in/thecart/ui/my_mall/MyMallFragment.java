...
import in.thecart.CategoryAdapter;
import in.thecart.CategoryModel;
import in.thecart.DBquerries;
import in.thecart.HorizontalProductScrollModel;
import in.thecart.MainActivity;
import in.thecart.MyMallAdapter;
import in.thecart.MyMallModel;
import in.thecart.R;
import in.thecart.SliderModel;
import in.thecart.WishlistModel;
import com.bumptech.glide.Glide;

import java.util.ArrayList;
import java.util.List;

import static in.thecart.DBquerries.categoryModelList;
import static in.thecart.DBquerries.lists;
import static in.thecart.DBquerries.loadCategories;
import static in.thecart.DBquerries.loadFragmentData;
import static in.thecart.DBquerries.loadedCategoriesNames;
...
public class MyMallFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setColorSchemeColors(getContext().getResources().getColor(R.color.random),getContext().getResources().getColor(R.color.random),getContext().getResources().getColor(R.color.random));
