    ...
    class cartItemViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setItemDetails(final String productID, String resource, String title, Long freecoupansNo, final String productPriceText, String cuttedPriceText, Long offersAppliedNo, final int position, boolean inStock, final Long productQty, final Long maxQty, boolean qtyError, final List<String> qtyIDs, final long stockQty,boolean codAvaiiable){
            ...
            if(inStock) {
                ...
                if(!showDeleteBtn) {
                    if (qtyError) {
                        productQuantity.setTextColor(itemView.getContext().getResources().getColor(R.color.random));
                        productQuantity.setBackgroundTintList(ColorStateList.valueOf(itemView.getContext().getResources().getColor(R.color.random)));
                    } else {
                ...
                productPrice.setTextColor(itemView.getContext().getResources().getColor(R.color.random));
                cuttedPrice.setText("");
