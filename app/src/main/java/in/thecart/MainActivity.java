...
import in.thecart.ui.my_account.MyAccountFragment;
...
import in.thecart.databinding.ActivityMainBinding;


import static in.thecart.R.*;
    ...
    private void setFragment(Fragment fragment,int fragementNo){
        if(fragementNo!=currentFragment) {
            ...
            if(fragementNo==REWARDS_FRAGMENT){
                ...
                window.setStatusBarColor(getResources().getColor(color.random));
                toolbar.setBackgroundColor(getResources().getColor(color.random));
            }
